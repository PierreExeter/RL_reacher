...
def main():
    ...
    print("1111111111 Observation space: 1111111111", env.observation_space)
    ...
    ep_len = 0
    episode_is_success_list, reach_time_list = [], []
    ...
    for _ in range(args.n_timesteps):
        ...
        if done:
            ...
            print("ep_len when done", ep_len)

        pierre_success_list.append(infos[0]['is_success'])
        ...
        if args.n_envs == 1:
            ...
            if done and not is_atari and args.verbose > 0:   # PB: TD3 don't enter this loop
                ...
                episode_is_success_list.append(pierre_success_list[-1])
    ...
    if args.verbose > 0 and len(episode_rewards) > 0:
        ...
        print("success ratio:", np.mean(episode_is_success_list))
        ...
        d = {
            ...
            "success ratio": np.mean(episode_is_success_list),
