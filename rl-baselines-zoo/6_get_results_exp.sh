...
# python my_lib/clean_random_training.py -f ${random_log_folder}
...
# python my_lib/plot_experiment_comparison.py -f ${log_dir} -s ${save_dir} -e ${appendix} -r ${random_log_folder}
